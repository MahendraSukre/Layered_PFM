function plotDiscontinuosSolutionTwoMeshes(NitscheFaces,referenceElementStd,referenceElementRef,...
                                                         refinedElements,X,T,Xref,Tref,u,nDegRef)
...
nOfStdEls = length(standardElements);
...
for i = 1:nOfStdEls
    ...
    uplot = N*ue;
    hold on
    patch('Faces',elemTriRef,'Vertices',Xplot,'FaceVertexCData',uplot,'FaceColor','interp','EdgeAlpha',0);
end
