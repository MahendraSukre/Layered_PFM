function [K,f] = NitscheTwoMeshesLinearElasticityDamage_PF_hybC(X,T,Xref,Tref,NitscheFaces,refinedElements,referenceElementStd,referenceElementRef,E_elems,nu_elems,eta,beta,d,hybridCondition,hybridCondition_NitscheFaces)
