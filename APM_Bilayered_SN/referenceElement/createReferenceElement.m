...
%     .IPcoordinates: coordinates of the integration points for 2D elements
%     .IPweights: weights of the integration points for 2D elements
%     .N: shape functions at the IP
%     .Nxi,.Neta: derivatives of the shape functions at the IP in (\xi and \eta)
%     .IPcoordinates1d: coordinates of the integration points for 1D boundary elements
